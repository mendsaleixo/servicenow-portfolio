...
![Plugin de Tradução Instalado](/projetos/aumiau-virada-servicenow/docs/screenshots/lab01_01.png)

### 2. Configuração de Idioma para Português (Brasileiro)

![Idioma Configurado](/projetos/aumiau-virada-servicenow/docs/screenshots/lab01_02.png)

### 3. Ativação de Dicas de Ajuda (Help Tips)

![Dicas de Ajuda Ativas](/projetos/aumiau-virada-servicenow/docs/screenshots/lab01_03.png)
